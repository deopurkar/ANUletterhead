# This file creates the README and sty files for the ANU letterhead.

# Every style file needs the following declaration.
...
To use the letterhead:
 ...
 2. Issue ~\usepackage{ANUletterhead}~ in your tex file.
    By itself, this should create a left margin line in the ANU gold colour.
...
By default, the package uses sans serif font.
